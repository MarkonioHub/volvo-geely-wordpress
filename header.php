...
<head>
    ...
    <title>Сервис Джили в Москве 🚙 специализированный сервис Geely – автосервис RUSGEELY</title>
    <meta name="description" content="Сервисный центр Geely в Москве с гарантией в профильном техцентре. Звоните 📞: +7 (499) 450-49-08. 👨‍🔧 Ремонт и техобслуживание Джили в Москве в сети специализированных СТО с низкими ценами | Автосервис RUSGEELY">

    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $GLOBALS["STATIC_IMG_PATH"]?>/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo $GLOBALS["STATIC_IMG_PATH"]?>/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo $GLOBALS["STATIC_IMG_PATH"]?>/favicon/favicon-16x16.png">
    <link rel="icon" href="<?php echo $GLOBALS["STATIC_IMG_PATH"]?>/favicon/favicon.ico" type="image/x-icon">
    <link rel="manifest" href="<?php echo $GLOBALS["STATIC_IMG_PATH"]?>/favicon/site.webmanifest">
    <link rel="mask-icon" href="<?php echo $GLOBALS["STATIC_IMG_PATH"]?>/favicon/safari-pinned-tab.svg" color="#737a7c">
...
<header data-element="header" class="<?php echo $slug === 'policy' ? 'header header_black' : 'header' ?>">
    <div class="container">
        <div class="header__top">
            <div class="header__burger" data-element="mobile-menu-open">
                <svg width="56" height="44" viewBox="0 0 56 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_319_229" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="56" height="44">
                        <rect width="56" height="44" fill="#D9D9D9" />
                    </mask>
                    <g mask="url(#mask0_319_229)">
                        <path d="M18 19L38 19" stroke="white" stroke-width="1.5" />
                        <path d="M18 26L38 26" stroke="white" stroke-width="1.5" />
                    </g>
                </svg>
            </div>
            <div class="header__left">
                <a href="#cap" class="header__logo" data-role="scroll-to-anchor">
                ...
                <span class="header__logo-note">
                    <?php echo get_field('text_logo', $GLOBALS['SETTINGS_PAGE_ID']) ?>
                </span>
            </div>
            <nav class="header__nav">
                <ul class="header__nav-list">
                    <?php foreach ($GLOBALS["MENU"] as $key => $item): ?>
                        <li class="header__nav-item">
                            <a href="/#<?php echo $item['link'] ?>" class="header__nav-link" data-element="header-nav-link"
                               data-role = "<?php echo $slug === 'policy' ? '' : 'scroll-to-anchor' ?>">
                                <?php echo $item['text'] ?>
                            </a>
                        </li>
                    <?php endforeach ?>
            ...
            <div class="header__right">
                <div class="header__contacts">
                    <a href="tel:<?php echo get_field('contacts', $GLOBALS['SETTINGS_PAGE_ID'])['phone']['mask'] ?>" class="header__phone">
                        <?php echo get_field('contacts', $GLOBALS['SETTINGS_PAGE_ID'])['phone']['text'] ?>
                    </a>
                    <div class="header__work-time"><?php echo get_field('work_time', $GLOBALS['SETTINGS_PAGE_ID']) ?></div>
                </div>
                <a href="#modal-registration" class="header__registration btn-black btn-black_hover-blue" data-fancybox>
                    Запись на сервис
                </a>
            </div>
        </div>
